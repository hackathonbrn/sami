...
namespace YOLOAnalytics.yolo
{
    ...
    {
        const string path = @"C:\Users\Александр\source\repos\YOLOAnalytics\YOLOAnalytics";
        public const int MaxObjects = 1000;
        private const string YoloLibraryCpu = path + @"\yoloData\x64\yolo_cpp_dll_cpu.dll";
        private const string YoloLibraryGpu = path + @"\yoloData\x64\yolo_cpp_dll_gpu.dll";
